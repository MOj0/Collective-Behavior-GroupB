...
We have successfully implemented a basic Boid model with selected modifications and took elements from
the HoPE model to implement escape maneuvers to simulate predator-prey behavior.
...
and attack strategies could be incorporated to the model. We could extend the simulation by introducing multiple predators.
