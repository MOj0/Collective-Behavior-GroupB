...
\begin{abstract}
In this research paper we present the simulation of bird behaviour in nature.
Namely, we simulate how they behave (move) in a flock.
...
\acknow{Matija Ojo: Initial boid implementation and report fixes, Miha Krajnc: Refactor boid implementation and report, Janez Kuhar: Initial report, Marko Adžaga: Report}
